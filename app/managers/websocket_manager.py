...
from app.managers.pubsub_manager import RedisPubSubManager
...
class WebSocketManager:
    def __init__(self):
        ...
        self.chats: dict = (
            {}
        )  # stores user WebSocket connections by chat {"chat_guid": {ws1, ws2}, ...}
        self.pubsub_client = RedisPubSubManager()
        self.user_guid_to_websocket: dict = (
            {}
        )  # stores user_guid: {ws1, ws2} combinations
        ...
        try:
            while True:
                ...
                if message is not None:
                    ...
                    if isinstance(chat_guid, bytes):
                        chat_guid = chat_guid.decode("utf-8")
            ...
            logger.exception("Websocket pubsub reader failed: %s", exc)
